      ...
      <section className="flex min-h-screen w-full flex-col justify-center px-5 py-8 sm:px-10 lg:w-[48%] lg:px-14 xl:px-20">
        <div className="mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="block text-sm font-medium" htmlFor="username">Email<div className="relative mt-2"><UserRound className="pointer-events-none absolute left-3 top-3 h-4 w-4 text-[#69706a]" aria-hidden="true" /><input id="username" type="email" value={username} onChange={(event) => setUsername(event.target.value)} autoComplete="email" placeholder="you@company.com" required className="h-12 w-full border border-[#c9c7bc] bg-white pl-10 pr-3 text-sm outline-none transition focus:border-[#161a18]" /></div></label>
